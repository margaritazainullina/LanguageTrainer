 ...
 * a {@link VocabularyActivityFragment}.
 */
public class ItemDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(VocabularyActivityFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(VocabularyActivityFragment.ARG_ITEM_ID));
