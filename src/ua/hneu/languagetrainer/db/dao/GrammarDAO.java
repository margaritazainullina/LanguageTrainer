...
public class GrammarDAO extends ContentProvider {

	public static String TABLE_NAME = "grammar";
	...
	public Uri insert(Uri url, ContentValues inValues) {
		...
		long rowId = db.insert(TABLE_NAME, RULE, values);
		if (rowId > 0) {
